...
load_icode(struct Env *e, uint8_t *binary)
{
	...
	// code for lab 3 -M.G
	struct PageInfo* page_for_stack = page_alloc(ALLOC_ZERO);
	if(0!=page_insert(e->env_pgdir,page_for_stack, (void*)(USTACKTOP - PGSIZE), PTE_U|PTE_W))
		panic("load_icode(): error inpage_insert");
