...
static int
sys_E1000_tx_packet(char *data, int num_bytes)
{
    return E1000_tx_packet(data, num_bytes);
}

static int
sys_E1000_rx_packet(char *buf, size_t max_size)
{
    return E1000_rx_packet(buf, max_size);
}
...
syscall(uint32_t syscallno, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	...
	switch(syscallno)
    {
        ...
        case SYS_E1000_tx_packet:
            return sys_E1000_tx_packet((char *)a1, a2);    
    
        case SYS_E1000_rx_packet:
            return sys_E1000_rx_packet((char*)a1, a2);
